...
// NearSens v33 2MHz calibrated-truth profile.
// Goal: keep the v23/v24-style stable echo behavior, but stop calibration from
// snapping/smoothing readings to calibration targets. This header does not force
// clock. Set 2 MHz in megaTinyCore/Arduino IDE.
...
static const uint8_t EEPROM_VERSION = 18;
