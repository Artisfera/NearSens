...
static const uint8_t EEPROM_VERSION = 8;
...
static const uint8_t MEASURE_PINGS = 49;
static const uint8_t MEASURE_MIN_VALID = 5;
static const uint8_t MEASURE_MIN_CLUSTER = 4;
static const uint16_t MEASURE_CLUSTER_MM = 15;

static const uint8_t CAL_PINGS = 35;
static const uint8_t CAL_MIN_VALID = 5;
static const uint8_t CAL_MIN_CLUSTER = 4;
static const uint16_t CAL_CLUSTER_MM = 15;
...
static const uint32_t ECHO_TIMEOUT_FROM_TX_START_US = 4500UL;
static const uint16_t ECHO_MIN_MM = 60;
static const uint16_t ECHO_MAX_MM = 700;
static const bool ENABLE_FAR_FALLBACK = false;

static const uint16_t ADC_THRESHOLD_MIN = 6;
...
static const uint16_t ADC_CONFIRM_MARGIN = 1;
static const uint16_t ADC_STRONG_CONFIRM_MARGIN = 3;
...
static const uint16_t CAL_POINT_MAX_SPREAD_MM = 20;
static const uint16_t CAL_RAW_MIN_SEPARATION_100_300_MM = 80;
static const uint16_t CAL_RAW_MIN_SEPARATION_300_500_MM = 80;
static const uint16_t CAL_VALID_RAW100_MIN_MM = 35;
static const uint16_t CAL_VALID_RAW100_MAX_MM = 260;
static const uint16_t CAL_VALID_RAW300_MIN_MM = 140;
static const uint16_t CAL_VALID_RAW300_MAX_MM = 560;
static const uint16_t CAL_VALID_RAW500_MIN_MM = 260;
