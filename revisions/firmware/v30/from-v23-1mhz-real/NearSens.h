...
static const uint8_t CAL_PINGS = 85;
...
static const uint32_t ECHO_TIMEOUT_FROM_TX_START_US = 7200UL;
static const uint16_t ECHO_MIN_MM = 60;
static const uint16_t ECHO_MAX_MM = 1100;
...
static const uint16_t ADC_STRONG_CONFIRM_MARGIN = 4;
...
static const uint8_t CAL_POINT_SAMPLES = 3;
static const uint8_t CAL_POINT_MIN_GOOD = 1;
...
static const uint16_t FAR_ECHO_START_MM = 320;
