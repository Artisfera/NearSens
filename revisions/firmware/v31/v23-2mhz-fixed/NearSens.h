...
static const uint8_t EEPROM_VERSION = 16;
...
static const uint8_t MEASURE_PINGS = 33;
static const uint8_t MEASURE_MIN_VALID = 5;
static const uint8_t MEASURE_MIN_CLUSTER = 4;
static const uint16_t MEASURE_CLUSTER_MM = 10;

static const uint8_t CAL_PINGS = 41;
static const uint8_t CAL_MIN_VALID = 6;
static const uint8_t CAL_MIN_CLUSTER = 4;
static const uint16_t CAL_CLUSTER_MM = 14;
...
static const uint32_t ECHO_TIMEOUT_FROM_TX_START_US = 6500UL;
...
static const uint8_t CAL_POINT_SAMPLES = 5;
static const uint8_t CAL_POINT_MIN_GOOD = 2;
static const uint16_t CAL_POINT_MAX_SPREAD_MM = 22;
