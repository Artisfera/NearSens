/*
  NearSens v24 five-point calibration firmware.

  Calibration:
  - wizard points: 100, 200, 300, 400, 500 mm
  - EEPROM format v11 stores all five raw calibration points
  - old EEPROM v10 data with 100/300/500 mm is migrated on first boot

  Measurement changes kept from earlier versions:
  ...
  Kept features:
  - TS3 measurement
  - TS4 toggles 75 mm offset; BODY subtracts DEVICE_REFERENCE_OFFSET_MM exactly once in displayed normal result
