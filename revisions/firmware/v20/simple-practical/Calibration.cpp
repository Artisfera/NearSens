...
bool loadCalibrationV9() {
  ...
  if (magic0 != EEPROM_MAGIC0 || magic1 != EEPROM_MAGIC1 ||
      ...
      storedChecksum != calibrationChecksumV9(storedRaw100, storedRaw300, storedRaw500, flags)) {
    calibrationValid = false;
    calibrationFlags = 0;
    return false;
  }
...
void saveCalibration() {
  ...
  EEPROM.update(EEPROM_CHECKSUM_ADDR, calibrationChecksumV9(calibrationRaw100Mm,
                                                            calibrationRaw300Mm,
                                                            calibrationRaw500Mm,
                                                            flags));
}
