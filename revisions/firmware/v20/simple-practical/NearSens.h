...
static const uint8_t EEPROM_VERSION = 9;
...
static const uint8_t MEASURE_PINGS = 31;
...
static const uint32_t ECHO_TIMEOUT_FROM_TX_START_US = 5000UL;
...
static const uint8_t CAL_POINT_MIN_GOOD = 4;
static const uint16_t CAL_POINT_MAX_SPREAD_MM = 35;
...
bool loadCalibrationV9();
void saveCalibration();
uint8_t calibrationChecksumV9(uint16_t raw100Mm, uint16_t raw300Mm, uint16_t raw500Mm, uint8_t flags);
