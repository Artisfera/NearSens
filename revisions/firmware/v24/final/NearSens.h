...
// NearSens v24 1MHz profile.
// Tuning goal: more reliable echo capture and calibration at F_CPU = 1 MHz.
// This header does not force the clock. Set 1 MHz in megaTinyCore/Arduino IDE.
