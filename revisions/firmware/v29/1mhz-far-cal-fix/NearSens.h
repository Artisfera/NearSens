...
static const uint8_t EEPROM_VERSION = 15;
...
static const uint8_t MEASURE_PINGS = 37;
static const uint8_t MEASURE_MIN_VALID = 4;
static const uint8_t MEASURE_MIN_CLUSTER = 3;
static const uint16_t MEASURE_CLUSTER_MM = 12;

static const uint8_t CAL_PINGS = 37;
static const uint8_t CAL_MIN_VALID = 4;
static const uint8_t CAL_MIN_CLUSTER = 3;
static const uint16_t CAL_CLUSTER_MM = 16;
...
static const uint32_t ECHO_TIMEOUT_FROM_TX_START_US = 7600UL;
static const uint16_t ECHO_MIN_MM = 60;
static const uint16_t ECHO_MAX_MM = 1150;
...
static const uint16_t ADC_FAR_THRESHOLD_MIN = 3;
...
static const uint16_t ECHO_MIN_PULSE_WIDTH_US = 18;
...
static const uint8_t CAL_POINT_SAMPLES = 150;
static const uint8_t CAL_POINT_MIN_GOOD = 8;
static const uint16_t CAL_POINT_MAX_SPREAD_MM = 32;

static const uint16_t CAL_FAR_STRICT_CLUSTER_MM = 55;
static const uint16_t CAL_FAR_FALLBACK_CLUSTER_MM = 95;
static const uint8_t CAL_FAR_MIN_GOOD = 4;
static const uint8_t CAL_FAR_MIN_CLUSTER = 3;
static const uint16_t CAL_MID_STRICT_CLUSTER_MM = 38;
static const uint16_t CAL_MID_FALLBACK_CLUSTER_MM = 70;
static const uint8_t CAL_MID_MIN_GOOD = 5;
static const uint8_t CAL_MID_MIN_CLUSTER = 3;
...
static const uint16_t FAR_ECHO_START_MM = 260;
...
extern uint16_t echoWindowMinMm;
extern uint16_t echoWindowMaxMm;
