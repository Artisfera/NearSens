...
static const uint8_t EEPROM_VERSION = 6;
...
static const uint16_t MEASURE_CLUSTER_MM = 25;

static const uint8_t CAL_PINGS = 35;
static const uint8_t CAL_MIN_VALID = 16;
static const uint8_t CAL_MIN_CLUSTER = 10;
static const uint16_t CAL_CLUSTER_MM = 25;
...
static const uint32_t ECHO_TIMEOUT_FROM_TX_START_US = 9000UL;
static const uint16_t ECHO_MIN_MM = 60;
static const uint16_t ECHO_MAX_MM = 1500;
...
static const uint16_t CAL_RAW_MIN_SEPARATION_MM = 70;
static const uint16_t CAL_500_RAW_MIN_MM = 380;
static const uint16_t CAL_500_RAW_MAX_MM = 650;
static const bool ENABLE_DEEP_SLEEP = false;
...
static const uint16_t LCD_RX_FAULT = 4005;
static const uint16_t LCD_RINGDOWN_LONG = 4006;
...
extern bool calibration100Loaded;
extern bool calibration300Loaded;
extern bool calibration500Loaded;
