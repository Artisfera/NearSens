...
static const uint8_t EEPROM_VERSION = 14;
...
static const uint16_t CAL_CLUSTER_MM = 12;
...
static const uint8_t CAL_POINT_SAMPLES = 90;
static const uint8_t CAL_POINT_MIN_GOOD = 8;
static const uint16_t CAL_POINT_MAX_SPREAD_MM = 24;
