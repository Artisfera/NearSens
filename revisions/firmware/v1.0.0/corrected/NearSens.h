...
// Firmware profile for the NearSens prototype.
// The code assumes operation tested at F_CPU = 1 MHz, but it does not set the MCU clock.
// Clock nalezy setic in Arduino IDE/megaTinyCore before compilation.
...
#define EEPROM_RAW200_L_ADDR 5
#define EEPROM_RAW200_H_ADDR 6
#define EEPROM_RAW300_L_ADDR 7
#define EEPROM_RAW300_H_ADDR 8
#define EEPROM_RAW400_L_ADDR 9
#define EEPROM_RAW400_H_ADDR 10
#define EEPROM_RAW500_L_ADDR 11
#define EEPROM_RAW500_H_ADDR 12
#define EEPROM_FLAGS_ADDR    13
#define EEPROM_CHECKSUM_ADDR 14

static const uint8_t EEPROM_MAGIC0 = 0x4E;
static const uint8_t EEPROM_MAGIC1 = 0x53;
static const uint8_t EEPROM_VERSION = 11;
static const uint8_t EEPROM_FLAG_100_VALID = 0x01;
static const uint8_t EEPROM_FLAG_200_VALID = 0x02;
static const uint8_t EEPROM_FLAG_300_VALID = 0x04;
static const uint8_t EEPROM_FLAG_400_VALID = 0x08;
static const uint8_t EEPROM_FLAG_500_VALID = 0x10;
...
static const uint8_t TX_CYCLES = 16;
static const uint8_t TX_HALF_PERIOD_US = 12;

static const uint8_t MEASURE_PINGS = 45;
static const uint8_t MEASURE_MIN_VALID = 7;
static const uint8_t MEASURE_MIN_CLUSTER = 4;
static const uint16_t MEASURE_CLUSTER_MM = 14;

static const uint8_t CAL_PINGS = 60;
static const uint8_t CAL_MIN_VALID = 8;
static const uint8_t CAL_MIN_CLUSTER = 5;
static const uint16_t CAL_CLUSTER_MM = 18;

static const uint16_t INTER_PING_MS = 24;
...
static const uint16_t MEASURE_POWER_SETTLE_MS = 450;
static const uint8_t ADC_WARMUP_READS = 48;
...
static const uint16_t BASELINE_SAMPLES = 14;
static const uint16_t ECHO_GUARD_AFTER_TX_US = 115;
static const uint32_t ECHO_TIMEOUT_FROM_TX_START_US = 6400UL;
static const uint16_t ECHO_MIN_MM = 85;
static const uint16_t ECHO_MAX_MM = 850;
static const bool ENABLE_FAR_FALLBACK = false;

static const uint16_t ADC_THRESHOLD_MIN = 4;
static const uint16_t ADC_THRESHOLD_EXTRA = 2;
static const uint16_t ADC_FAR_THRESHOLD_MIN = 4;
static const uint16_t ADC_FAR_THRESHOLD_EXTRA = 2;
static const uint16_t ADC_CONFIRM_MARGIN = 0;
static const uint16_t ADC_STRONG_CONFIRM_MARGIN = 2;
static const uint16_t ADC_CONFIRM_WINDOW_US = 170;
static const uint16_t ADC_NOISE_FAULT = 150;

static const uint8_t ECHO_CANDIDATE_MAX = 10;
static const uint8_t ECHO_MIN_PULSE_HITS = 1;
static const uint16_t ECHO_MIN_PULSE_WIDTH_US = 0;
static const uint16_t ECHO_MAX_PULSE_WIDTH_US = 900;
static const uint16_t ECHO_PEAK_TIE_MARGIN = 18;
static const uint16_t ADC_RAIL_LOW = 25;
static const uint16_t ADC_RAIL_HIGH = 998;

static const uint16_t CAL_100_TARGET_MM = 100;
static const uint16_t CAL_200_TARGET_MM = 200;
static const uint16_t CAL_300_TARGET_MM = 300;
static const uint16_t CAL_400_TARGET_MM = 400;
static const uint16_t CAL_500_TARGET_MM = 500;
static const uint8_t CAL_POINT_COUNT = 5;
static const uint8_t CAL_POINT_SAMPLES = 11;
static const uint8_t CAL_POINT_MIN_GOOD = 5;
static const uint16_t CAL_POINT_MAX_SPREAD_MM = 30;
static const uint16_t CAL_RAW_MIN_SEPARATION_STEP_MM = 25;
static const uint16_t CAL_VALID_RAW100_MIN_MM = 50;
static const uint16_t CAL_VALID_RAW100_MAX_MM = 360;
static const uint16_t CAL_VALID_RAW200_MIN_MM = 80;
static const uint16_t CAL_VALID_RAW200_MAX_MM = 540;
static const uint16_t CAL_VALID_RAW300_MIN_MM = 120;
static const uint16_t CAL_VALID_RAW300_MAX_MM = 720;
static const uint16_t CAL_VALID_RAW400_MIN_MM = 170;
static const uint16_t CAL_VALID_RAW400_MAX_MM = 850;
static const uint16_t CAL_VALID_RAW500_MIN_MM = 220;
static const uint16_t CAL_VALID_RAW500_MAX_MM = 900;
static const uint16_t FAR_ECHO_START_MM = 330;
...
extern uint16_t calibrationRaw200Mm;
extern uint16_t calibrationRaw300Mm;
extern uint16_t calibrationRaw400Mm;
extern uint16_t calibrationRaw500Mm;
extern uint16_t pendingCalibrationRaw100Mm;
extern uint16_t pendingCalibrationRaw200Mm;
extern uint16_t pendingCalibrationRaw300Mm;
extern uint16_t pendingCalibrationRaw400Mm;
