/*
  ...
  Firmware for prototype version v1.0.0. The code handles ultrasonic
  measurement, five-point 100-500 mm calibration, EEPROM storage,
  RAW mode, 75 mm correction and LCD codes.
